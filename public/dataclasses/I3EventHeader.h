 ...
 * $Id: I3EventHeader.h,v 1.10.14.1 2005/04/16 19:14:12 niessen Exp $
 *
 * @file I3EventHeader.h
 * @version $Revision: 1.10.14.1 $
 * @date $Date: 2005/04/16 19:14:12 $
 * @author ehrlich
 * @author troy
 * @author pretz
 */
...
class I3EventHeader : public I3DataHeader{
  ULong_t  fRunId;
  ULong_t  fEventId;
  ULong64_t  fRawStartTime;
  ULong64_t  fRawEndTime;
 ...
 public:
  ...
  ULong64_t GetRawStartTime() const { return fRawStartTime; }

  /**
   * @param set "Raw" daq event start time
   */
  void SetRawStartTime(ULong64_t starttime) { fRawStartTime = starttime; }
  ...
  ULong64_t GetRawEndTime() const { return fRawEndTime; }

  /**
   * @param set "Raw" daq event end time
   */
  void SetRawEndTime(ULong64_t endtime) { fRawEndTime = endtime; }
