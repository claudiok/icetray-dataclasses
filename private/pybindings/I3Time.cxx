...
#endif
    .def_readonly("ModJulianDay", &I3Time::GetModJulianDay)
    .def_readonly("ModJulianSec", &I3Time::GetModJulianSec)
    .def_readonly("ModJulianNanoSec", &I3Time::GetModJulianNanoSec)
    .def_readonly("ModJulianDayDouble", &I3Time::GetModJulianDayDouble)
    .def_readonly("UTCYear", &I3Time::GetUTCYear)
    .def_readonly("UTCMonth", &I3Time::GetUTCMonth)
    .def_readonly("UTCDaqTime", &I3Time::GetUTCDaqTime)
    .def_readonly("UnixTime", &I3Time::GetUnixTime)
    .def("__str__",&dump)
    .def("__repr__",&repr)
    .def(self == self)
    .def(self-self)
