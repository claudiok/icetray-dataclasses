...
void register_I3Time()
{
  ...
  scope i3time_scope = class_<I3Time, bases<I3FrameObject>, 
    ...
    .add_property("UnixTime", &I3Time::GetUnixTime, &I3Time::SetUnixTime(unixTime, ns))
    .def("SetDaqTime", &I3Time::SetDaqTime)
#ifdef HAVE_PYDATETIME_API
    .add_property("DateTime", &GetDateTime)
#endif
    .add_property("ModJulianDay", &I3Time::GetModJulianDay)
    .add_property("ModJulianSec", &I3Time::GetModJulianSec)
    .add_property("ModJulianNanoSec", &I3Time::GetModJulianNanoSec)
    .add_property("ModJulianDayDouble", &I3Time::GetModJulianDayDouble)
    .add_property("UTCYear", &I3Time::GetUTCYear)
    .add_property("UTCMonth", &I3Time::GetUTCMonth)
    .add_property("UTCDaqTime", &I3Time::GetUTCDaqTime)
    .def("__str__",&dump)
    .def("__repr__",&repr)
    .def(self == self)
    .def(self-self)
