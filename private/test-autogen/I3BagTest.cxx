/**
    ...
    $Id: I3BagTest.cxx,v 1.4 2004/10/11 07:06:11 troy Exp $
...
namespace tut
{
  ...
  typedef test_group<I3BagTest> factory;
...
namespace
{
  static tut::factory t("I3BagTest");
}
...
{ 
  ...
  void object::test<2>()
  {
     ...
     /** @todo should fill some data for I3Bag here */
     ...
     TObject* object_in =
		f_in.FindObjectAny("I3Bag");
     f_in.Close();
     ensure("the read-in pointer is non-zero",object_in);
     
     I3Bag* tested_in = dynamic_cast<I3Bag*>(object_in);
     ensure("the read-in pointer is of the right type",tested_in);

     I3BagPtr ptr_in(tested_in);
    
    /** @todo should check the read-in data for I3Bag here */
   ...
   tree.Branch("branch","I3Bag",&raw_ptr);
   
   tree.Fill();

   I3Bag* raw_ptr_in = new I3Bag();
   I3BagPtr ptr_in (raw_ptr_in);

   tree.SetBranchAddress("branch",&raw_ptr_in);
   tree.GetEvent(0);

   /** @todo add some checking of the data of I3Bag here */
