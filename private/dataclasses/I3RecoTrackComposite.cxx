...
const I3RecoTrack& I3RecoTrackComposite::GetConstituent(unsigned short number) const {return((GetNumberConstituents()<=number) ? *(I3RecoTrack*)NULL : *(I3RecoTrack*)constituent->At(number));}
