...
const I3MCTrackList* I3MCTrackData::GetMCTrackList(unsigned short number) const {return((GetNumberMCTrackLists()<=number) ? NULL : (I3MCTrackList*)mctracklist->At(number));}
