...
#include <dataclasses/physics/I3Shower.h>

I3Shower::~I3Shower() {}

void I3Shower::ToStream(ostream& o) const
{
  o<<"Position:\n"<<pos_;
  o<<"Direction:\n"<<dir_;
  o<<"Time: "<<time_<<"\n";
...
template <class Archive>
  void I3Shower::serialize(Archive& ar, unsigned version)
  {
