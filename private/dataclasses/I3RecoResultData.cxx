...
const I3RecoResult* I3RecoResultData::GetRecoResult(unsigned short number) const {return((GetNumberRecoResults()<=number) ? NULL : (I3RecoResult*)recoresult->At(number));}
