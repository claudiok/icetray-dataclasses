...
const I3RecoTrackList* I3RecoResult::GetRecoTrackList(unsigned short index) const      {return((GetNumberRecoTrackLists()<=index) ? NULL : (I3RecoTrackList*)recotracklist->At(index));}
...
const I3RecoTrackList* I3RecoResult::GetBestRecoTrackList() const                              {return((bestrecotracklist==NULL) ? NULL : (I3RecoTrackList*)bestrecotracklist.GetObject());}
